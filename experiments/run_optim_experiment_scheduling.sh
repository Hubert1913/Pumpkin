#!/bin/bash
#SBATCH --job-name=nogood-metrics-scheduling
#SBATCH --array=0-144
#SBATCH --ntasks=1
...
# ── Paths ────────────────────────────────────────────────────────────────────
FZN_DIR="/scratch/hnowak/nogood-metrics/optim/flatzinc_scheduling"
...
OUT_DIR="/scratch/hnowak/nogood-metrics/optim/outputs_scheduling"
CSV_DIR="/scratch/hnowak/nogood-metrics/optim/out_data_scheduling"
